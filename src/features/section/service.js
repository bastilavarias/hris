...
module.exports = {
    create: async ({code, name, description, yearLevel, collegeId, courseId}) => {
        ...
        await sectionModel.create({code, name, description, yearLevel, collegeId, courseId});
    ...
    update: async (sectionId, {name, description, yearLevel, collegeId, courseId}) => {
        let message;
        await sectionModel.update(sectionId, {name, description, yearLevel, collegeId, courseId});
    ...
    search: async (option, value) => {
        ...
        return await sectionModel.search(options[option], value.trim().toLowerCase());
    },
