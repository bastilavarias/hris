      ...
      <v-card>
        ...
        <v-card-text>
          <v-row no-gutters>
            <v-col cols="12">
              <div class="text-center">
                <generic-image-input
                  ...
                  :preview.sync="form.profile.photoPreview"
                ></generic-image-input>
              </div>
            </v-col>
            <v-col cols="12">
            ...
            <v-col cols="12">
              <generic-department-selection
                label="Department"
                outlined
                :department-id.sync="form.departmentId"
              ></generic-department-selection>
            </v-col>
            <v-col cols="12">
              <generic-designation-selection
                label="Designation"
                outlined
                :designation-id.sync="form.designationId"
              ></generic-designation-selection>
            </v-col>
            <v-col cols="12">
              <v-radio-group
          ...
          <v-tabs-items v-model="tab">
              ...
              <v-row dense>
                ...
                <v-col cols="12">
                  ...
                  <generic-benefit-form
                    ...
                    :agency-employee-number.sync="
                      form.profile.benefit.agencyEmployeeNumber
                    "
                  ></generic-benefit-form>
                </v-col>
                <v-col cols="12">
                  ...
                  <generic-contact-form
                    :telephone-number.sync="
                      form.profile.contact.telephoneNumber
                    "
              ...
              <v-row dense>
                <v-col cols="12">
                  ...
                  <generic-address-form
                    :house-number.sync="
                      form.profile.address.permanent.houseNumber
                    "
                    :street.sync="form.profile.address.permanent.street"
                    :subdivision.sync="
                      form.profile.address.permanent.subdivision
                    "
                ...
                <v-col cols="12">
                  ...
                  <generic-address-form
                    :house-number.sync="
                      form.profile.address.residential.houseNumber
                    "
                    :street.sync="form.profile.address.residential.street"
                    :subdivision.sync="
                      form.profile.address.residential.subdivision
                    "
              ...
              <v-row dense>
                ...
                <v-col cols="12" md="12" class="mb-10">
                  ...
                  <generic-children-information-table
                    :children.sync="form.profile.family.children"
                  ></generic-children-information-table>
                </v-col>
              </v-row>
            </v-tab-item>
              ...
              <v-row dense>
                <v-col cols="12">
                  ...
                  <generic-educational-background-table
                    :education.sync="form.profile.education"
                  ></generic-educational-background-table>
                </v-col>
                <v-col cols="12">
                  <generic-subtitle>Civil Service Eligibility</generic-subtitle>
                  <generic-civil-service-eligibility
                    :civil-service-eligibility.sync="
                      form.profile.civilServiceEligibility
                    "
                  ></generic-civil-service-eligibility>
                </v-col>
                <v-col cols="12">
                  ...
                  <generic-work-experience
                    :work-experiences.sync="form.profile.workExperiences"
                  ></generic-work-experience>
                </v-col>
                <v-col cols="12">
                  <generic-subtitle
                    >Voluntary Work Experience / Voluntary Organization(s)
                  </generic-subtitle>
                  <generic-voluntary-work-experience
                    :voluntary-work-experiences.sync="
                      form.profile.voluntaryWorkExperiences
                    "
                  ></generic-voluntary-work-experience>
                </v-col>
                <v-col cols="12" class="mb-10">
                  <generic-subtitle
                    >L & D Interventions / Training Programs Attended
                  </generic-subtitle>
                  <generic-training-table
                    :trainings.sync="form.profile.trainings"
                  ></generic-training-table>
                </v-col>
              </v-row>
            </v-tab-item>
            <v-tab-item>
              <v-row dense>
                <v-col cols="12" md="4">
                  <generic-list-input
                    :list.sync="form.profile.hobbies"
                    label="Hobbies"
                  ></generic-list-input>
                </v-col>
                <v-col cols="12" md="4">
                  <generic-list-input
                    :list.sync="form.profile.recognitions"
                    label="Recognitions"
                  ></generic-list-input>
                </v-col>
                <v-col cols="12" md="4">
                  <generic-list-input
                    :list.sync="form.profile.organizations"
                    label="Organizations"
                  ></generic-list-input>
                </v-col>
                <v-col cols="12">
                  ...
                  <generic-reference-table
                    :references.sync="form.profile.references"
                  ></generic-reference-table>
                </v-col>
                <v-col cols="12">
                  ...
                  <generic-government-issue-id-form
                    :government-id.sync="
                      form.profile.governmentIssueId.governmentId
                    "
                    :license-number.sync="
                      form.profile.governmentIssueId.licenseNumber
                    "
                    :issuance-place.sync="
                      form.profile.governmentIssueId.issuancePlace
                    "
                    :issuance-date.sync="
                      form.profile.governmentIssueId.issuanceDate
                    "
                  ></generic-government-issue-id-form>
                </v-col>
              </v-row>
  ...
  computed: {
    isFormValid() {
      return (
        ...
        this.form.profile.citizenship.length > 0
      );
    }
  },
  ...
  watch: {
    "$store.state.employee.current"(employee) {
      if (Object.keys(employee).length <= 0)
        return this.$router.push({ name: "employee-management" });
      const {
        employeeNumber,
        isFullTime,
        department,
      ...
      this.form.profile.address.residential.houseNumber =
      ...
      this.form.profile.address.residential.province = residential.province
        ...
        : "";
      this.form.profile.address.residential.subdivision =
      ...
      this.form.profile.civilServiceEligibility = civilServiceEligibility
        ? civilServiceEligibility
        : [];

      this.form.profile.workExperiences = workExperiences
        ? workExperiences
        : [];

      this.form.profile.voluntaryWorkExperiences = voluntaryWorkExperiences
        ? voluntaryWorkExperiences
        : [];
      ...
      this.form.profile.governmentIssueId.governmentId = governmentId
        ? governmentId
        : "";
      this.form.profile.governmentIssueId.licenseNumber = licenseNumber
        ? licenseNumber
        : "";
      this.form.profile.governmentIssueId.issuanceDate = issuanceDate
        ? issuanceDate
        : "";
      this.form.profile.governmentIssueId.issuancePlace = issuancePlace
        ? issuancePlace
        : "";
    },
