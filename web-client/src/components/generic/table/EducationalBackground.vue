  ...
  >
    ...
    <template v-slot:item.recognition="{ item }">
      <span class="text-capitalize">{{
        item.recognition ? item.recognition : "N/A"
      }}</span>
    </template>
    <template v-slot:item.scholarship="{ item }">
      <span class="text-capitalize">{{
        item.scholarship ? item.scholarship : "N/A"
      }}</span>
    </template>
...
export default {
  ...
  methods: {
    ...
    remove(row) {
      ...
      this.educationLocal = this.educationLocal.filter(
