              ...
              <v-row dense>
                ...
                <v-col cols="12" md="6">
                  <v-select
                    label="Salary Grade"
                    outlined
                    v-model="form.monthlySalaryGrade"
                  ></v-select>
                </v-col>
                <v-col cols="12" md="3">
                  <v-select
                ...
                <v-col cols="12" md="6">
                  <v-radio-group
                    ...
                    v-model="form.isGovernmentService"
                  >
                    <v-radio label="Yes" :value="true"></v-radio>
                    <v-radio label="No" :value="false"></v-radio>
                  </v-radio-group>
  ...
  methods: {
    add() {
      if (
        ...
        this.workExperiencesLocal = [...this.workExperiencesLocal, this.form];
        this.clearForm();
      }
    },
    ...
    remove(row) {
      ...
      this.workExperiencesLocal = this.workExperiencesLocal.filter(
